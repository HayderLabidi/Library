                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                    <div class="slider-content slider-animated-1">
                                        ...
                                        <div class="slider-btn btn-hover">
                                            <div class="animated" href="#">SHOP NOW</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
            ...
            <div class="product-area pb-60">
                <div class="container">
                    ...
                    <div class="product-tab-list nav pt-30 pb-55 text-center">
                        <div href="#product-1" data-bs-toggle="tab" >
                            <h4>New Arrivals  </h4> </div>

                        <div class="active" href="#product-2" data-bs-toggle="tab">
                            <h4>Best Sellers </h4></div>

                        <div href="#product-3" data-bs-toggle="tab">
                            <h4>Sale Items</h4></div>
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-action">
                                                <div class="pro-same-action pro-wishlist">
                                                    <div title="Wishlist" href="#"><i class="pe-7s-like"></i></div>
                                                </div>
                                                <div class="pro-same-action pro-cart">
                                                    <div title="Add To Cart" href="#"><i class="pe-7s-cart"></i> Add to cart</div>
                                                </div>
                                                <div class="pro-same-action pro-quickview">
                                                    <div title="Quick View" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="pe-7s-look"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-content text-center">
                                            <h3>Crew Ventile Coat</h3>
                            ...
                            <div class="blog-wrap mb-30 scroll-zoom">
                                ...
                                <div class="blog-content-wrap">
                                    <div class="blog-content text-center">
                                        <h3>Lorem ipsum dolor sit <br /> amet consec.</h3>
                                        <span>By Shop Admin</span>
                                    </div>
                                </div>
                            </div>
                        </div>
